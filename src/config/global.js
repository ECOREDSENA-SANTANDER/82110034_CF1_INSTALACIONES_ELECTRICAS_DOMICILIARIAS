export default {
  global: {
    Name: 'Fundamentos de electricidad para instalaciones en casa',
    Description:
  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        nombreRuta: 'tema1',
        numero: '1',
        titulo: 'Fundamentos esenciales de electricidad',
        desarrolloContenidos: true,
        /*subMenu: [
          {
            numero: '1.1',
...

      {
        nombreRuta: 'tema2',
        numero: '2',
        titulo: 'Medidas eléctricas',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema3',
        numero: '3',
        titulo: 'Leyes fundamentales en electricidad',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema4',
        numero: '4',
        titulo: 'Elementos de un circuito y resistencias',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema5',
        numero: '5',
        titulo:
          'Estudio de los divisores de tensión y corriente y del comportamiento dinámico de condensadores e inductores en circuitos eléctricos',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema6',
        numero: '6',
        titulo: 'Transformadores de energía',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema7',
